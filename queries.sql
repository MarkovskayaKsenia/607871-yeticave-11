...
VALUES ('2019-10-30 12:30:15', '2014 Rossignol District Snowboard','Самая крутая доска на свете, с горы летишь как ветер.','img/lot-1.jpg', 10999, '2019-11-02', 100, 1, 2, 1),
       ...
       ('2019-11-06 10:44:18', 'Крепления Union Contact Pro 2015 года размер L/XL','Самые крутые крепы! Влетел на доске в дерево: доска в щепки, крепам - хоть бы хны. Но теперь, без доски, для меня в них нет смысла :(','img/lot-3.jpg', 8000, '2019-11-09', 50, 3, NULL, 2),
       ('2019-11-06 15:10:56', 'Ботинки для сноуборда DC Mutiny Charocal','Эти ботинки служили трем поколениям нашей семьи, от сердца отрываю.','img/lot-4.jpg', 10999, '2019-11-10', 70, 2, NULL, 3),
       ('2019-11-06 09:18:25', 'Куртка для сноуборда DC Mutiny Charocal','Куртка хорошая, почти не ношеная. Покупал для девушки, но она поправилась не влезает, отдаю за полцены.','img/lot-5.jpg', 7500, '2019-11-08', 150, 2, NULL, 4),
       ('2019-11-06 14:01:08', 'Маска Oakley Canopy','Маска, как маска, че ее пробовать... Царапин нет, двойные линзы с покрытием Anti-fog, регулируемый ремешок.','img/lot-6.jpg', 5400, '2019-11-09', 70, 2, NULL, 6);
