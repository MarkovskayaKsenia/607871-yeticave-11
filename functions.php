 ...
 * @param string $str - текстовые данные, введенные пользователем.
 *
 ...
 * @param int $num - значение, которое нужно проверить.
 ...
 *
 * @param mixed $pass - пароль, вводимый пользователем при регистрации.
